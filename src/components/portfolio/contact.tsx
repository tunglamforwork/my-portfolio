			...
			<div className='max-w-7xl mx-auto'>
				<div className='max-w-2xl'>
					<FadeIn>
						...
						<h2 className='text-4xl md:text-5xl font-[700] mb-5 leading-tight'>
							Building something interesting?
						</h2>
						<p
							className='font-[500] text-[17px] leading-relaxed mb-10'
							style={{ color: C.muted }}
						>
							Always open to discussing products, engineering, AI systems, and ambitious ideas.
						</p>
					</FadeIn>
